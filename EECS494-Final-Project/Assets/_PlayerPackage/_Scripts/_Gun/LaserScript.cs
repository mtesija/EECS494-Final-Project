...
public class LaserScript : MonoBehaviour 
{
	...
	void Start()
	{
		...
		//Just some basic lineRenderer settings like color, length (determined by rayDistance), width, texture and shader. 
	}
	...
	void Update () 
	{
		...
		{			
			if(hit.collider)
			{
				...
				laserCircle.transform.position = hit.point;						//Put the lasercircle at the end of the hit.point of the raycast.
